...
def lstm_parse(parser, arg_str=None):
    ...
    enc_parser.set_defaults(
                            ...
                            model_save = 'Final/Energy_pv/model/model_e2000.pt',
                            pred_result='Final/Energy_pv/output/lstm_predict.csv',
                            result_train='Final/Energy_pv/output/lstm_train.png',
                            result_pred='Final/Energy_pv/output/lstm_predict.png',
                            )    # True
